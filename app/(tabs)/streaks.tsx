...
// ✅ Ensure proper React component naming convention (PascalCase)
export default function StreaksScreen() {
    ...
    // 🔹 Fetch all habits belonging to the current user
    ...
    useEffect(() => {
        ...
        const completionsChannel = `databases.${DATABASE_ID}.collections.${COMPLETION_TABLE}.documents`;
